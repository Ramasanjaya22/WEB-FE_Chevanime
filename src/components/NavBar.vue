<template>
    <div>
      ...
      <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
            ...
            <li v-if="isLogin"><a class="btn btn-ghost text-black" @click.prevent="doLogout">{{ user.displayName }} (Logout)</a></li>
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal p-0">
            ...
            <li v-if="isLogin"><a class="btn btn-ghost" @click.prevent="doLogout">{{ user.displayName }} (Logout)</a></li>
